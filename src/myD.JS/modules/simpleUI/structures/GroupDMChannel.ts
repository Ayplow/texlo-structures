import { GroupDMChannel as OldGroupDMChannel, Message, MessageEmbed, EmojiResolvable, User } from 'discord.js';
export default class GroupDMChannel extends OldGroupDMChannel {
